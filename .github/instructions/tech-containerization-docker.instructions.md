...
The following instructions only apply to projects that use Docker for containerization.
...
- **Guidance for Copilot:**
    ...
    - For services that need to communicate, use service names and discovery instead of IP addresses for better reliability.
